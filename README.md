...
```python
from visionprint import success, info, dim, warn, error
...
| <code>dim(msg: str)</code>                                              | Grey, faint                                         |
| <code>warn(msg: str)</code>                                             | Yellow, bold, underline                             |
| <code>error(msg: str)</code>                                            | Red, underline                                      |
| <code>rule(msg: str, color=Colors.WHITE)</code>                         | Header with a proportional horizontal rule (bold)   |
| <code>box(msg: str, color=Colors.WHITE, align: str = "center")</code>   | Simple colored box around the message (bold)        |
